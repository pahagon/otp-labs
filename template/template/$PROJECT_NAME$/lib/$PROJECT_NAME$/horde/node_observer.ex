defmodule <%= @project_name_camel_case %>.Horde.NodeObserver do
  @moduledoc ~S"""
  ...
  def handle_info({:nodeup, node, _node_type}, state) do
    ...
    set_members(<%= @project_name_camel_case %>.Horde.Registry)
    set_members(<%= @project_name_camel_case %>.Horde.Supervisor)
